...
public class ReadClassVisitor extends GJDepthFirst<Integer, MySymbolTable> {   //to arg tha  allaksei se domi
    ...
    public Integer visit(Goal n, MySymbolTable myTable) {
        ...
        LineOfError.value = n.f0.f1.f0.beginLine ;
    ...
    public Integer visit(ClassDeclaration n, MySymbolTable myTable) {
        ...
        LineOfError.value = n.f1.f0.beginLine ;
        mySymbol = new Cclass(symbolName);
        myTable.insert(symbolName,mySymbol);
        return null;
    }
    ...
    public Integer visit(ClassExtendsDeclaration n, MySymbolTable myTable) {
        ...
        LineOfError.value = n.f3.f0.beginLine ;
        MySymbol motherExists = myTable.getSymbol(motherClass);
        if(motherExists==null) {                         //check if mother class exists
            System.out.println("ReadClassVisitor.visit(ClassExtendsDeclartion)::Mother class doesn't exist" + " (line " + Integer.toString(LineOfError.value)+")");
